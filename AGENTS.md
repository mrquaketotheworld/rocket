...
- **Предлагай лучшие практики.** Если пользователь пробует устаревшую технологию, deprecated API
  или устаревший паттерн в языке программирования, явно предложи современную альтернативу и
  кратко объясни причину. Не меняй намерение пользователя молча; при конфликте с canonical truth,
  безопасностью или поддерживаемостью — остановись и эскалируй.
